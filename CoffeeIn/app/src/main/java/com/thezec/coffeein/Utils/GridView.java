...
public class GridView extends android.widget.GridView implements OnScrollListener, AdapterView.OnItemClickListener {
        ...
        if (mHeaderViewInfo != null) {
            ...
            if (lastPos != startPos && !setFixed && bringToFront) {
                if (mScrollOfsset <= headerViewHeight) {
                    RelativeLayout.LayoutParams mParams = (RelativeLayout.LayoutParams) mHeaderViewInfo.view.getLayoutParams();
